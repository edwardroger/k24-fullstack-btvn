...
import footer_bg from '../images/footer-bg.webp'
...
function Footer(props) {
    return (
        <div>
            <div class="bg-footer">
                <img src={footer_bg} class="img-responsion" alt="Lofi Nest" />
            </div>
            <footer class="footer">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6 col-12 col-left">
                                <div class="link-list col-footer">
                                    ...
                                    <div class="desc">
                                        Chuyên cung cấp các loại sản phẩm từ yến đảm bảo an toàn – uy tín – chất lượng. Vua Yến là món quà gửi gắm sự yêu thương, nâng niu sức khoẻ cho chính bạn, cho chính những người thân yêu quanh mình.
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 link-list col-footer">
                                <h4 class="title-menu">
                                    Về chúng tôi
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-12 link-list col-footer">
                                <h4 class="title-menu">
                                    Thông tin liên hệ
                                    <span class="Collapsible__Plus"></span>
                                </h4>
